...
function add() {
  ...
  checkButton.addEventListener("click", (event) =>
    check(currentUserItem, currentUserItemInfo, addDiv, event)
  );
...
function check(currentLi, currentLiInfo, currentDiv, event) {
  ...
  let refreshButton = currentDiv.querySelector(".fa-refresh");
  console.log(refreshButton);
  refreshButton.addEventListener("click", (event) =>
    refresh(event, currentLi, currentLiInfo, currentDiv)
  );
}

function refresh(event, currentLi, currentLiInfo, currentDiv) {
